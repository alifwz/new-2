            ...
            <div class="notification">
                ...
                <?php } else { ?>
                    ...
                    <div class="threebtns">
                        <div class="row intrested-edit-cancel">
                            <div class="col-4 intrested-div">
                                <a data-type="submitfavourites.php?id=<?php echo $memid; ?>&workid=<?php echo $workid ?>&r=1" href="javascript:void(0);" class="button loginpopup">Interested</a>
                            </div>
                            <div class="col-4 edit-div">
                                <a data-type="listing-detail.php" href="javascript:void(0);" class="button light-yellow loginpopup">Interested if</a>
                            </div>	
                            <div class="col-4 cancel-div">
