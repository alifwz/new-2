...
//    if ($redirect) {
    echo '<script type="text/javascript">window.location = "listing-detail.php?id=" . $clientid . "&status=success"</script>';
//    header("location: listing-detail.php?id=" . $clientid . "&status=success");
//    }
}
